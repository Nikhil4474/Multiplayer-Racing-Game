...
// Changing anmation to blast when lifetime
      ...
      // Move car down
      if (keyIsDown(DOWN_ARROW) && this.blast === false) {
        this.playerMoving = true
        player.positionY -= 10;
        player.update();
      }
      // Move car right
      if (keyIsDown(RIGHT_ARROW) && player.positionX < 1250 && this.blast === false) {
        this.playerMoving = true;
        this.leftkey = false;
        player.positionX += 10;
        player.update();
      ...
      // Move car left
      if (keyIsDown(LEFT_ARROW) && player.positionX > 550 && this.blast === false) {
        this.playerMoving = true;
        this.leftkey = true;
        player.positionX -= 10;
        player.update();
